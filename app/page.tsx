...
import KartuSoalTrueFalse from '@/components/KartuSoalTrueFalse';
          ...
          <div className="space-y-6">
            ...
            {showKunciJawaban ? (
              ...
              <div className="space-y-6">
                {(() => {
                  const countByType = {
                    PG: parseResult.questions.filter(q => q.type === 'PG').length,
                    TRUE_FALSE: parseResult.questions.filter(q => q.type === 'TRUE_FALSE').length,
