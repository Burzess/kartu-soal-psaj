    ...
    <div className="w-full bg-white border-2 border-black print:border-black print:break-after-page text-black text-[12px] leading-normal" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="grid grid-cols-[24%_76%] min-h-155">
        <div className="border-r border-black">
          {labelData.map(({ label, value }) => (
            <div key={label} className="border-b border-black">
              <div className="bg-[#c8c8c8] font-bold text-center py-1 border-b border-black flex items-center justify-center min-h-[28px]">{label}</div>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="border border-black">
            <div className="bg-[#c8c8c8] font-bold text-center border-b border-black flex items-center justify-center min-h-[28px]">Uraian Jawaban</div>
